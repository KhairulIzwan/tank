...
class TankFaceDetector:
	...
	def __init__(self):
		...
		self.sub = rospy.Subscriber("/camPi/image_raw",Image, self.callback)
		self.pub = rospy.Publisher("/roi",RegionOfInterest,queue_size=10)

		self.faceCascade = cv2.CascadeClassifier("/home/pi/catkin_ws/src/tank/library/haarcascade_frontalface_default.xml")
